      ...
      <a href="{{route('home')}}"> <img src="{{ asset('homepublic/website icons/OBS_Logo Left_White Text_RGB_Eng.png')}}" class="logo" style="float: left;"></a>
        ...
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button">
			...
			<label style="color: white;font-size: 25px;padding-left: 20%;padding-top: 5px;"> Service Desk Management Portal</label>
          <!-- Navbar Right Menu -->
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="user-header">
                        <img src="{{ asset('storage/'.Auth::user()->imagelocation)}}" class="img-circle" alt="User Image" />
                        <p>
                            {{Auth::user()->name}}
                                  ...
                                  <div class="pull-left">
                                      <form id="formimgupload" method="post" action="{{route('imageupload')}}"
                                          ...
                                          <label class="btn btn-default btn-file">
                                              Edit image<input id="uploadimagefile" type="file" name="image" accept="image/*" onchange="this.form.submit()" hidden>
                                          </label>
                                      </form>
                                  </div>
